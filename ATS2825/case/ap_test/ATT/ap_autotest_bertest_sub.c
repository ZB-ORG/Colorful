...
static void _ber_test_report_result(ber_test_arg_t *ber_arg, uint8 ret_val)
{
 ...
 说明:
*/
static uint8  _ber_test_stop_att(ber_test_arg_t *ber_arg)
{
    uint32 ret_val;   
    uint32 read_len;
    uint8 *pdata;
...
/** 
 ...
 说明: 
*/
static uint8 _ber_test_write_berdata(uint8 pkt_index)
{
    uint32 i;
...
/** 
 ...
 说明:
*/
static uint8 _ber_test_init(ber_test_arg_t *ber_arg)
{
    uint32 retry_cnt;
    uint32 ret_val;
